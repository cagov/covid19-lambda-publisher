...
const pantheonService = async (req) => { 
  var message = '';
  try { // The entire module
    ...
    message = 'PantheonService ran successfully';
    ...
    message = `<h1>${errorTitle}</h1><h2>Error Text</h2><pre>${e.stack}</pre><h2>Original Request</h2><pre>${JSON.stringify(req,null,2)}</pre>`;
...
module.exports = { pantheonService };